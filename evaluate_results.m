...
input_dir = fullfile(pwd,'your_results/Ocatve_SRResNet_16_64_alpha=0.5/set14');

% Directory with ground truth images
GT_dir = fullfile(pwd,'self_validation_HR/set14');
...
%% Printing results
perceptual_score =mean([scores.NIQE]); %%%(mean([scores.NIQE]) + (10 - mean([scores.Ma]))) / 2;
